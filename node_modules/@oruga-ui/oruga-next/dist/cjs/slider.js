...
var vue = require('vue');
var Tooltip = require('./Tooltip-3ad1ce0a.js');
...
var script$2 = vue.defineComponent({
    name: 'OSliderThumb',
    components: {
        [Tooltip.script.name]: Tooltip.script
    },
    configField: 'slider',
    inheritAttrs: false,
    inject: ['$slider'],
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    }), [_ctx.indicator ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, vue.toDisplayString(_ctx.formattedValue), 1 /* TEXT */)) : vue.createCommentVNode("v-if", true)], 16 /* FULL_PROPS */, _hoisted_1)]),
    _: 1 /* STABLE */
...
var script = vue.defineComponent({
    ...
    props: {
        ...
        tooltip: {
            type: Boolean,
            default: () => {
                return helpers.getValueByPath(config.getOptions(), 'slider.tooltip', true);
            }
        },
        /**
        ...
        rounded: {
            type: Boolean,
            default: () => {
                return helpers.getValueByPath(config.getOptions(), 'slider.rounded', false);
            }
        },
        disabled: {
            type: Boolean,
...
exports.OSlider = script;
exports.OSliderTick = script$1;
