...
var vue = require('vue');
var Button = require('./Button-8f12537a.js');
var Checkbox = require('./Checkbox-46554079.js');
var Icon = require('./Icon-ba0295bf.js');
var Input = require('./Input-db40662c.js');
var Loading = require('./Loading-d0d3335d.js');
var SlotComponent = require('./SlotComponent-b10f11e8.js');
var Select = require('./Select-4d02b5ff.js');
var Field = require('./Field-02e29bc5.js');
var helpers = require('./helpers.js');
var Pagination = require('./Pagination-bdb896ed.js');
var plugins = require('./plugins-7c8be2b1.js');
var MatchMediaMixin = require('./MatchMediaMixin-0a436641.js');
var config = require('./config.js');
require('./CheckRadioMixin-2a894e60.js');
require('./FormElementMixin-476f0435.js');
    ...
    default: vue.withCtx(() => [vue.createVNode(_component_o_select, {
      ...
      default: vue.withCtx(() => [_ctx.placeholder ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("option", {
        ...
        return vue.openBlock(), vue.createElementBlock("option", {
          key: index,
          value: column.newKey
        }, vue.toDisplayString(column.label), 9 /* TEXT, PROPS */, _hoisted_1$2);
      }), 128 /* KEYED_FRAGMENT */))]),
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [vue.createElementVNode("div", null, [vue.renderSlot(_ctx.$slots, "default")]), vue.createElementVNode("div", null, [_ctx.paginated ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [vue.createVNode(_component_o_pagination, {
        ...
        newColumns() {
            if (this.columns && this.columns.length) {
                return this.columns.map((column) => {
                    const vnode = vue.createVNode(script$2, column, (props) => {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
  ...
  }, [vue.createElementVNode("div", _hoisted_1, [vue.renderSlot(_ctx.$slots, "default")], 512 /* NEED_PATCH */), _ctx.isMobile && _ctx.hasSortablenewColumns ? (vue.openBlock(), vue.createBlock(_component_o_table_mobile_sort, {
    key: 0,
    ...
    key: 1,
    colspan: _ctx.columnCount
  }, [vue.renderSlot(_ctx.$slots, "footer")], 8 /* PROPS */, _hoisted_18))], 2 /* CLASS */)])) : vue.createCommentVNode("v-if", true)], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_2), vue.renderSlot(_ctx.$slots, "loading", {}, () => [vue.createVNode(_component_o_loading, {
    "full-page": false,
    active: _ctx.loading
...
var index = {
    install(app) {
        ...
        plugins.registerComponent(app, script$2);
    }
};

exports.OTable = script;
exports.OTableColumn = script$2;
