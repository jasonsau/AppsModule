...
var FormElementMixin = vue.defineComponent({
    ...
    props: {
        ...
        useHtml5Validation: {
            type: Boolean,
            default: () => {
                return helpers.getValueByPath(config.getOptions(), "useHtml5Validation", true);
            },
        },
        ...
        statusIcon: {
            type: Boolean,
            default: () => {
                return helpers.getValueByPath(config.getOptions(), "statusIcon", true);
            },
        },
        /**
    ...
    computed: {
        ...
        */
        statusVariantIcon() {
            const statusVariantIcon = helpers.getValueByPath(config.getOptions(), "statusVariantIcon", {
                'success': 'check',
                'danger': 'alert-circle',
                'info': 'information',
                'warning': 'alert'
        ...
        onInvalid(event) {
            ...
            if (validatable && this.parentField && this.useHtml5Validation) {
                ...
                if (isFirstInvalid) {
                    ...
                    const invalidHandler = helpers.getValueByPath(config.getOptions(), 'reportInvalidInput');
