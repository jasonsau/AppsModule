...
const faIcons = () => {
    const iconComponent = helpers.getValueByPath(config.getOptions(), 'iconComponent');
...
const getIcons = () => {
    ...
    const customIconPacks = helpers.getValueByPath(config.getOptions(), 'customIconPacks');
    if (customIconPacks) {
...
var script = vue.defineComponent({
    ...
    computed: {
        ...
        */
        ...
        newPack() {
            return this.pack || helpers.getValueByPath(config.getOptions(), 'iconPack', 'mdi');
        },
        newVariant() {
            if (!this.variant)
                return;
        ...
        useIconComponent() {
            ...
            const component = helpers.getValueByPath(config.getOptions(), 'iconComponent');
            if (component)
                return component;
            return null;
        }
