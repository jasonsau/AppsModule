...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
      ...
      size: _ctx.size
    }, null, 8 /* PROPS */, ["icon", "pack", "size"])) : childItem.step ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, vue.toDisplayString(childItem.step), 1 /* TEXT */)) : vue.createCommentVNode("v-if", true)], 2 /* CLASS */), vue.createElementVNode("div", {
      class: vue.normalizeClass(_ctx.stepLinkLabelClasses)
    }, vue.toDisplayString(childItem.label), 3 /* TEXT, CLASS */)], 10 /* CLASS, PROPS */, _hoisted_1)], 2 /* CLASS */)), [[vue.vShow, childItem.visible]]);
...
exports.OStepItem = script;
exports.OSteps = script$1;
