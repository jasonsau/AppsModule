...
var script = vue.defineComponent({
    ...
    props: {
        ...
        order: {
            type: String,
            default: () => { return helpers.getValueByPath(config.getOptions(), 'pagination.order', 'right'); }
        },
        /**
         * Icon pack to use
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("nav", {
  ...
  }, [vue.createCommentVNode("First"), _ctx.hasFirst ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_1, [_ctx.hasDefaultSlot ? vue.renderSlot(_ctx.$slots, "default", {
    key: 0,
    page: _ctx.getPage(1),
    linkClass: _ctx.linkClasses,
    linkCurrentClass: _ctx.linkCurrentClasses
    ...
    linkCurrentClass: _ctx.linkCurrentClasses,
    page: _ctx.getPage(1)
  }, null, 8 /* PROPS */, ["linkClass", "linkCurrentClass", "page"]))])) : vue.createCommentVNode("v-if", true), _ctx.hasFirstEllipsis ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_2, [vue.createElementVNode("span", {
  ...
  }), 128 /* KEYED_FRAGMENT */)), vue.createCommentVNode("Last"), _ctx.hasLastEllipsis ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_3, [vue.createElementVNode("span", {
    class: vue.normalizeClass(_ctx.ellipsisClasses)
  }, "…", 2 /* CLASS */)])) : vue.createCommentVNode("v-if", true), _ctx.hasLast ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_4, [_ctx.hasDefaultSlot ? vue.renderSlot(_ctx.$slots, "default", {
    key: 0,
