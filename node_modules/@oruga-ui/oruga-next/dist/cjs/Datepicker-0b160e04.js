...
var vue = require('vue');
var FormElementMixin = require('./FormElementMixin-476f0435.js');
var plugins = require('./plugins-7c8be2b1.js');
var MatchMediaMixin = require('./MatchMediaMixin-0a436641.js');
var helpers = require('./helpers.js');
var config = require('./config.js');
var DropdownItem = require('./DropdownItem-43f32f1e.js');
...
const _hoisted_1$2 = ["disabled", "onClick", "onMouseenter", "onKeydown", "tabindex"];
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    }), 128 /* KEYED_FRAGMENT */))], 2 /* CLASS */)) : vue.createCommentVNode("v-if", true)], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1$2)) : (vue.openBlock(), vue.createElementBlock("div", {
      key: index,
      class: vue.normalizeClass(_ctx.cellClasses(weekDay))
...
var script$1 = {
    ...
    mixins: [plugins.BaseComponentMixin, DatepickerMixin],
    configField: 'datepicker',
...
const _hoisted_1$1 = ["disabled", "onClick", "onMouseenter", "onKeydown", "tabindex"];
const _hoisted_2$1 = {
  key: 0,
  class: "events"
};
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("section", {
    ...
    }, [vue.createTextVNode(vue.toDisplayString($props.monthNames[date.getMonth()]) + " ", 1 /* TEXT */), $options.eventsDateMatch(date) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$1, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.eventsDateMatch(date), (event, index) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["event", event.type]),
        key: index
      }, null, 2 /* CLASS */);
    }), 128 /* KEYED_FRAGMENT */))])) : vue.createCommentVNode("v-if", true)], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1$1)) : (vue.openBlock(), vue.createElementBlock("div", {
      key: 1,
      class: vue.normalizeClass($options.cellClasses(date))
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    default: vue.withCtx(() => [vue.createVNode(_component_o_dropdown_item, {
      ...
      default: vue.withCtx(() => [vue.createElementVNode("header", {
        ...
        both: "",
        clickable: ""
      }, null, 8 /* PROPS */, ["icon", "pack"])], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1), [[vue.vShow, !_ctx.showPrev && !_ctx.disabled]]), vue.withDirectives(vue.createElementVNode("a", {
        ...
        both: "",
        clickable: ""
      }, null, 8 /* PROPS */, ["icon", "pack"])], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_2), [[vue.vShow, !_ctx.showNext && !_ctx.disabled]]), vue.createElementVNode("div", {
        ...
        default: vue.withCtx(() => [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.listOfMonths, month => {
          ...
          }, vue.toDisplayString(month.name), 9 /* TEXT, PROPS */, _hoisted_3);
        }), 128 /* KEYED_FRAGMENT */))]),
        ...
        default: vue.withCtx(() => [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.listOfYears, year => {
          return vue.openBlock(), vue.createElementBlock("option", {
            value: year,
            key: year
          }, vue.toDisplayString(year), 9 /* TEXT, PROPS */, _hoisted_4);
        }), 128 /* KEYED_FRAGMENT */))]),
