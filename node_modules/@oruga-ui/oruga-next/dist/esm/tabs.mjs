import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, renderSlot, Fragment, renderList, withDirectives, withKeys, withModifiers, createBlock, resolveDynamicComponent, withCtx, createCommentVNode, toDisplayString, vShow } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }), 128 /* KEYED_FRAGMENT */)), renderSlot(_ctx.$slots, "end")], 10 /* CLASS, PROPS */, _hoisted_1), createElementVNode("section", {
...
export { script as OTabItem, script$1 as OTabs, index as default };
