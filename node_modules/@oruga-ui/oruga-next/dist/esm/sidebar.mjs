...
import { defineComponent, withDirectives, openBlock, createElementBlock, normalizeClass, createCommentVNode, createVNode, Transition, withCtx, createElementVNode, renderSlot, vShow } from 'vue';
...
export { script as OSidebar, index as default };
