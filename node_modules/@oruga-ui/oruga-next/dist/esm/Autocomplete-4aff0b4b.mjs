import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, createVNode, mergeProps, withKeys, withModifiers, Transition, withCtx, withDirectives, createElementVNode, normalizeStyle, renderSlot, createCommentVNode, Fragment, renderList, toDisplayString, vShow } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    default: withCtx(() => [withDirectives(createElementVNode("div", {
    ...
    }, [renderSlot(_ctx.$slots, "header")], 10 /* CLASS, PROPS */, _hoisted_2)) : createCommentVNode("v-if", true), (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.computedData, (element, groupindex) => {
      return openBlock(), createElementBlock(Fragment, null, [element.group ? (openBlock(), createElementBlock("div", {
        ...
        group: element.group,
        index: groupindex
      }) : (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString(element.group), 1 /* TEXT */))], 10 /* CLASS, PROPS */, _hoisted_3)) : createCommentVNode("v-if", true), (openBlock(true), createElementBlock(Fragment, null, renderList(element.items, (option, index) => {
        return openBlock(), createElementBlock("div", {
          ...
          option: option,
          index: index
        }) : (openBlock(), createElementBlock("span", _hoisted_6, toDisplayString(_ctx.getValue(option)), 1 /* TEXT */))], 10 /* CLASS, PROPS */, _hoisted_5);
    ...
    }, [renderSlot(_ctx.$slots, "empty")], 10 /* CLASS, PROPS */, _hoisted_7)) : createCommentVNode("v-if", true), _ctx.$slots.footer ? (openBlock(), createElementBlock("div", {
      key: 2,
      is: _ctx.itemTag,
      ref: "footer",
      role: "button",
    ...
    }, [renderSlot(_ctx.$slots, "footer")], 10 /* CLASS, PROPS */, _hoisted_8)) : createCommentVNode("v-if", true)], 14 /* CLASS, STYLE, PROPS */, _hoisted_1), [[vShow, _ctx.isActive && (!_ctx.isEmpty || _ctx.$slots.empty || _ctx.$slots.header || _ctx.$slots.footer)]])]),
    _: 3 /* FORWARDED */
