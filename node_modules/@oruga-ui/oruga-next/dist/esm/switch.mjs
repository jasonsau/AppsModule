import { defineComponent, openBlock, createElementBlock, normalizeClass, withKeys, withModifiers, withDirectives, createElementVNode, vModelCheckbox, renderSlot } from 'vue';
...
const _hoisted_1 = ["disabled", "name", "required", "value", "true-value", "false-value", "aria-labelledby"];
const _hoisted_2 = ["id"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 10 /* CLASS, PROPS */, _hoisted_1), [[vModelCheckbox, _ctx.computedValue]]), createElementVNode("span", {
...
export { script as OSwitch, index as default };
