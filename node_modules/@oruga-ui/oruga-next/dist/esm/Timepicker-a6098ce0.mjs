import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, createBlock, mergeProps, createSlots, withCtx, createVNode, Fragment, renderList, toDisplayString, createElementVNode, createCommentVNode, renderSlot, withKeys } from 'vue';
import { s as script$4, a as script$5 } from './DropdownItem-bf81cb78.mjs';
import { s as script$1 } from './Input-5b84d324.mjs';
import { s as script$2 } from './Select-2ed6c9d4.mjs';
import { s as script$3 } from './Icon-e7ad13c9.mjs';
    ...
    default: withCtx(() => [createVNode(_component_o_dropdown_item, {
      ...
      default: withCtx(() => [createVNode(_component_o_select, mergeProps({
        ...
        default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.hours, hour => {
          ...
          }, toDisplayString(hour.label), 9 /* TEXT, PROPS */, _hoisted_1);
        }), 128 /* KEYED_FRAGMENT */))]),
        ...
        default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.minutes, minute => {
          ...
          }, toDisplayString(minute.label), 9 /* TEXT, PROPS */, _hoisted_2);
        }), 128 /* KEYED_FRAGMENT */))]),
        ...
        default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.seconds, second => {
          ...
          }, toDisplayString(second.label), 9 /* TEXT, PROPS */, _hoisted_3);
        }), 128 /* KEYED_FRAGMENT */))]),
        ...
        default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.meridiens, meridien => {
          ...
          }, toDisplayString(meridien), 9 /* TEXT, PROPS */, _hoisted_4);
        }), 128 /* KEYED_FRAGMENT */))]),
