...
import { defineComponent, resolveComponent, openBlock, createBlock, Transition, withCtx, withDirectives, createElementVNode, normalizeClass, createElementBlock, createVNode, createCommentVNode, resolveDynamicComponent, mergeProps, toHandlers, renderSlot, vShow, render as render$2 } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(Transition, {
    ...
    }, null, 8 /* PROPS */, ["pack", "icon", "size"])], 10 /* CLASS, PROPS */, _hoisted_1)) : createCommentVNode("v-if", true), _ctx.component ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.component), mergeProps({
      key: 1
    ...
    }, null, 8 /* PROPS */, _hoisted_2)) : renderSlot(_ctx.$slots, "default", {
      key: 1,
...
export { NotificationProgrammatic, script$1 as ONotification, index as default };
