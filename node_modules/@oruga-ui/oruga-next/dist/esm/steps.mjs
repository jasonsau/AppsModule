import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, Fragment, renderList, withDirectives, createCommentVNode, createBlock, toDisplayString, vShow, renderSlot, createVNode, withModifiers } from 'vue';
import { s as script$2 } from './Button-b2686fa8.mjs';
...
import { T as TabbedMixin, a as TabbedChildMixin } from './TabbedChildMixin-274f470d.mjs';
...
import './InjectedChildMixin-52b9a851.mjs';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    return withDirectives((openBlock(), createElementBlock("div", {
      ...
      size: _ctx.size
    }, null, 8 /* PROPS */, ["icon", "pack", "size"])) : childItem.step ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(childItem.step), 1 /* TEXT */)) : createCommentVNode("v-if", true)], 2 /* CLASS */), createElementVNode("div", {
      class: normalizeClass(_ctx.stepLinkLabelClasses)
    }, toDisplayString(childItem.label), 3 /* TEXT, CLASS */)], 10 /* CLASS, PROPS */, _hoisted_1)], 2 /* CLASS */)), [[vShow, childItem.visible]]);
...
export { script as OStepItem, script$1 as OSteps, index as default };
