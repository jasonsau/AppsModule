import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, createVNode, withCtx, createElementVNode, mergeProps, withKeys, withModifiers, toDisplayString, createCommentVNode, renderSlot, Fragment, renderList, createBlock } from 'vue';
import { s as script$3 } from './Tooltip-c9093c86.mjs';
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    }), [_ctx.indicator ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(_ctx.formattedValue), 1 /* TEXT */)) : createCommentVNode("v-if", true)], 16 /* FULL_PROPS */, _hoisted_1)]),
    _: 1 /* STABLE */
...
export { script as OSlider, script$1 as OSliderTick, index as default };
