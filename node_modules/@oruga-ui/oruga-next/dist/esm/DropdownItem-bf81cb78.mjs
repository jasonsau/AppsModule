import { defineComponent, resolveDirective, openBlock, createElementBlock, normalizeClass, withModifiers, renderSlot, createCommentVNode, createVNode, Transition, withCtx, withDirectives, vShow, normalizeStyle, createBlock, resolveDynamicComponent } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
  ...
  })], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1)) : createCommentVNode("v-if", true), createVNode(Transition, {
    name: _ctx.animation
  }, {
    ...
    }, null, 10 /* CLASS, PROPS */, _hoisted_2)), [[vShow, _ctx.isActive]]) : createCommentVNode("v-if", true)]),
    _: 1 /* STABLE */
    ...
    }, [renderSlot(_ctx.$slots, "default")], 14 /* CLASS, STYLE, PROPS */, _hoisted_3)), [[vShow, !_ctx.disabled && (_ctx.isActive || _ctx.isHoverable) || _ctx.inline], [_directive_trap_focus, _ctx.trapFocus]])]),
    _: 3 /* FORWARDED */
