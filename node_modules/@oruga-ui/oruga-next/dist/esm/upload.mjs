import { defineComponent, openBlock, createElementBlock, normalizeClass, renderSlot, withModifiers, createElementVNode, mergeProps } from 'vue';
...
export { script as OUpload, index as default };
